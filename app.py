...
def index():
    if current_user.is_authenticated:
        return (
            ...
            'Consider setting your diet <a href="/prefs">preferences</a>'
        )
    else:
...
# from https://python-adv-web-apps.readthedocs.io/en/latest/flask_forms.html
